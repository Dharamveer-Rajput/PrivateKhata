...
public class MainActivitySpreadSheet extends Activity implements EasyPermissions.PermissionCallbacks {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.sheets.v4.Sheets.Builder(
                    ...
                    .setApplicationName("Private Khata")
                    .build();
        }
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = "1brqGBAgjEDZ0GfuKqr0At7QOIO7t4zz6TmM0YW0oisw";
            String range = "ClientData";
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            MainActivitySpreadSheet.REQUEST_AUTHORIZATION);
                } else {
